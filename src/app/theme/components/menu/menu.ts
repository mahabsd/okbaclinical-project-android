...
export const verticalMenuItems = [ 
   ...
   // new Menu (3, 'UI Features', null, null, 'computer', null, true, 0),   
    ...
    new Menu (20, 'Holydays', null, null, 'dvr', null, true, 0), 
    new Menu (21, 'Holidays request', '/Holydays/datepicker', null, 'today', null, false, 20), 
    new Menu (22, 'Holidays list', '/Holydays/Holidays-list', null, 'format_line_spacing', null, false, 20),
 ...
 //   new Menu (28, 'Slider', '/form-controls/slider', null, 'tune', null, false, 20), 
   ...
   // new Menu (32, 'Paging', '/tables/paging', null, 'last_page', null, false, 30), 
    ...
    new Menu (34, 'Holidays requests list', '/Holydays/holidays-requests-list', null, 'format_line_spacing', null, false, 20),
   // new Menu (35, 'Holidays-list', '/Maintenances/Holidays-list', null, 'playlist_add_check', null, false, 30),
