...
export const verticalMenuItems = [ 
   ...
   // new Menu (3, 'UI Features', null, null, 'computer', null, true, 0),   
    ...
    new Menu (21, 'Holidays request', '/form-controls/datepicker', null, 'today', null, false, 20), 
    new Menu (22, 'Holidays list', '/form-controls/Holidays-list', null, 'format_line_spacing', null, false, 20),
   // new Menu (23, 'Autocomplete', '/form-controls/autocomplete', null, 'short_text', null, false, 20), 
  //  new Menu (24, 'Checkbox', '/form-controls/checkbox', null, 'check_box', null, false, 20), 
    new Menu (24, 'Demande Maintenance ', '/form-controls/form-field', null, 'view_stream', null, false, 20), 
    new Menu (86, 'EnVoie Des SmS', '/form-controls/Envoie-sms', null, 'view_stream', null, false, 20), 
 ...
 //   new Menu (28, 'Slider', '/form-controls/slider', null, 'tune', null, false, 20), 
   ...
   // new Menu (32, 'Paging', '/tables/paging', null, 'last_page', null, false, 30), 
    new Menu (33, 'liste-maintenance',  '/tables/liste-maintenance', null, 'sort', null, false, 30),
...
export const horizontalMenuItems = [ 
    new Menu (1, 'Dashboard', '/', null, 'dashboard', null, false, 0),
    new Menu (2, 'Users', '/users', null, 'supervisor_account', null, false, 0),
    new Menu (18, 'Patients', '/patients', null, 'supervisor_account', null, false, 0),  
    new Menu (19, 'Doctors', '/doctors', null, 'groups', null, false, 0), 
    new Menu (37, 'Actionnaires', '/actionnaires', null, 'supervisor_account', null, false, 0), 
    new Menu (3, 'UI Features', null, null, 'computer', null, true, 0),   
    new Menu (4, 'Buttons', '/ui/buttons', null, 'keyboard', null, false, 3),  
