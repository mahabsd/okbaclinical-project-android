...
/* harmony import */ var _chat_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./chat.service */ "6PM2");
...
/* harmony import */ var src_app_theme_components_messages_messages_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/theme/components/messages/messages.service */ "5KN4");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let ChatComponent = class ChatComponent {
    constructor(appSettings, socket, chatService, auth, messagesService) {
    ...
    clickUser(idCandidat) {
        ...
        this.chatService.getPrivateMessage(idCandidat, this.userId).subscribe((res) => {
...
ChatComponent = __decorate([
    ...
    __metadata("design:paramtypes", [_app_settings__WEBPACK_IMPORTED_MODULE_3__["AppSettings"],
        ...
        src_app_theme_components_messages_messages_service__WEBPACK_IMPORTED_MODULE_9__["MessagesService"]])
], ChatComponent);
