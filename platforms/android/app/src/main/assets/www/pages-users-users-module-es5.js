(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-users-users-module"], {
    ...
    function P1L(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_services_AuthDeactivateGuard__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! src/app/services/AuthDeactivateGuard */
      "DvcX");
      ...
      var routes = [{
        path: '',
        canActivate: [src_app_services_AuthDeactivateGuard__WEBPACK_IMPORTED_MODULE_12__["AutheactivateGuard"]],
    ...
    function Ag98(module, __webpack_exports__, __webpack_require__) {
      ...
      var _user_dialog_user_dialog_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./user-dialog/user-dialog.component */
      "vfDu");
      /* harmony import */
      ...
      var UsersComponent = /*#__PURE__*/function () {
        function UsersComponent(appSettings, dialog, UserService, snackBar) {
        ...
        _createClass(UsersComponent, [{
          ...
          value: function updateUser(user) {
            ...
            this.UserService.updateUser(JSON.parse(user.get("_id")), user).subscribe(function (user) {
          ...
          value: function openUserDialog(user) {
            ...
            var dialogRef = this.dialog.open(_user_dialog_user_dialog_component__WEBPACK_IMPORTED_MODULE_8__["UserDialogComponent"], {
              data: user
            });
            dialogRef.afterClosed().subscribe(function (formData) {
              ...
              if (formData) {
                if (JSON.parse(user.get("_id")) != '') {
                  ...
                  _this4.updateUser(formData);
                } else {
                  formData["delete"]("_id");

                  _this4.addUser(formData);
                }
              }
            });
            this.showSearch = false;
          ...
          value: function openDialog(user) {
            ...
            dialogRef.afterClosed().subscribe(function (confirmed) {
              ...
              if (confirm) {
                _this5.UserService.deleteUser(user._id).subscribe(function (user) {
                  _this5.getUsers();
      ...
      UsersComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        selector: 'app-users',
      ...
      }), __metadata("design:paramtypes", [_app_settings__WEBPACK_IMPORTED_MODULE_5__["AppSettings"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialog"], src_app_services_login_service__WEBPACK_IMPORTED_MODULE_7__["LoginService"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_9__["MatSnackBar"]])], UsersComponent);
    ...
    /***/
    function DvcX(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AutheactivateGuard", function () {
        return AutheactivateGuard;
      });
      /* harmony import */
      ...
      var AutheactivateGuard = /*#__PURE__*/function () {
        function AutheactivateGuard(auth, router) {
          _classCallCheck(this, AutheactivateGuard);

          this.auth = auth;
          this.router = router;
        }

        _createClass(AutheactivateGuard, [{
          key: "canActivate",
      ...
      AutheactivateGuard.ctorParameters = function () {
        return [{
      ...
      AutheactivateGuard = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
        providedIn: 'root'
      }), __metadata("design:paramtypes", [_guardservice_service__WEBPACK_IMPORTED_MODULE_2__["GuardserviceService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]])], AutheactivateGuard);
      /***/
    },
    ...
    function vfDu(module, __webpack_exports__, __webpack_require__) {
      ...
      var UserDialogComponent = /*#__PURE__*/function () {
        function UserDialogComponent(dialogRef, user, userService, snackBar) {
        ...
        _createClass(UserDialogComponent, [{
          ...
          value: function openSnackBarUpdate() {
            ...
            Object.keys(this.form.value).forEach(function (fieldName) {
              _this7.formData.append(fieldName, JSON.stringify(_this7.form.value[fieldName]));
            });
          ...
          value: function openSnackBarAdd() {
            ...
            Object.keys(this.form.value).forEach(function (fieldName) {
              _this8.formData.append(fieldName, JSON.stringify(_this8.form.value[fieldName]));
            });
      ...
      }), __metadata("design:paramtypes", [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_3__["MatDialogRef"], _user_model__WEBPACK_IMPORTED_MODULE_5__["User"], src_app_services_login_service__WEBPACK_IMPORTED_MODULE_6__["LoginService"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_7__["MatSnackBar"]])], UserDialogComponent);
      /***/
    }
  }]);
})();
